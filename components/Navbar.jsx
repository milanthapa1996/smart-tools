...
const company = [
  { name: "About", href: "#", icon: ChevronDownIcon },
  { name: "Customers", href: "#", icon: ChevronDownIcon },
  { name: "Press", href: "#", icon: ChevronDownIcon },
  { name: "Careers", href: "#", icon: ChevronDownIcon },
  { name: "Privacy", href: "#", icon: ChevronDownIcon },
];
const resources = [
  { name: "Community", href: "#", icon: ChevronDownIcon },
  { name: "Partners", href: "#", icon: ChevronDownIcon },
  { name: "Guides", href: "#", icon: ChevronDownIcon },
  { name: "Webinars", href: "#", icon: ChevronDownIcon },
];
const blogPosts = [
  {
    id: 1,
